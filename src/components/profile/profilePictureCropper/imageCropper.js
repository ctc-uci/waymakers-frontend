...
const ImageCropper = ({
  imageSrc, setCropped, isOpen, setIsOpen, setPreview,
}) => {
  ...
  const handleSaveButtonClicked = async () => {
    ...
    if (croppedImageResizedFile) {
      reader.readAsDataURL(croppedImageResizedFile);
    }
    setIsOpen(false);
  };
  ...
  return (
    ...
    >
      ...
      <div className="button-section">
        <button type="button" className="save-crop-button" onClick={handleSaveButtonClicked}>
          <p className="small">Save</p>
        </button>
