...
//     const startDate =
// `${startMonth} ${event.startDay}${suffixDict[event.startDay % 10]
//  === undefined ? 'th' : suffixDict[event.startDay % 10]}`;
//     const endDate =
// `${endMonth} ${event.endDay}${suffixDict[event.endDay % 10]
...
// currentColor" className="bi bi-clock" viewBox="0 0 16 16">
//             <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .
// 252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z" />
//             <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0
...
//             <path d="M8 16s6-5.686 6-10A6 6 0 0
//  0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
//           </svg>
//           {' '}
//           {event.location}
//         </h4>
